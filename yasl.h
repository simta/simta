...
int yaslcmp(const yastr str1, const yastr str2);


// Modification //
void yaslclear(yastr str);

yastr yaslgrowzero(yastr str, size_t len);

yastr yaslcpylen(yastr dest, const char *src, size_t len);

yastr yaslcpy(yastr dest, const char *src);
...
yastr yaslmapchars(yastr str, const char *from, const char *to, size_t setlen);

void yaslrange(yastr str, ptrdiff_t start, ptrdiff_t end);

void yaslstrip(yastr str, const char *cset);

void yasltolower(yastr str);
...
yastr *yaslsplitargs(const char *line, size_t *argc);

yastr *yaslsplitlen(const char *str, size_t len, const char *sep, size_t seplen,
        size_t *count);


// Concatenation //
yastr yaslcat(yastr dest, const char *src);

yastr yaslcatyasl(yastr dest, const yastr src);

yastr yaslcatlen(yastr dest, const void *src, size_t len);

yastr yaslcatrepr(yastr dest, const char *src, size_t len);

yastr yaslcatvprintf(yastr str, const char *fmt, va_list ap);

yastr yaslcatprintf(yastr str, const char *fmt, ...)
        __attribute__((format(printf, 2, 3)));


// Freeing //
void yaslfree(yastr str);
...
size_t yaslAllocSize(yastr str);

void yaslIncrLen(yastr str, size_t incr);

yastr yaslMakeRoomFor(yastr str, size_t addlen)
        __attribute__((warn_unused_result));

yastr yaslRemoveFreeSpace(yastr str) __attribute__((warn_unused_result));
