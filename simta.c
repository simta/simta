...
static int simta_config_bool(
        const char *, int *, int, char **, const char *, int);
static int simta_config_int(
        const char *, int *, int, int, char **, const char *, int);
...
simta_read_config(const char *fname) {
    ...
    while ((line = snet_getline(snet, NULL)) != NULL) {
        ...
        if (*av[ 0 ] == '@') {
            ...
            if (ac <= 2) {
                fprintf(stderr, "%s: line %d: expected 1 or more arguments\n",
                        fname, lineno);
                goto error;
            }
            ...
            if (strcasecmp(av[ 2 ], "NOT_FOUND") == 0) {
                ...
                red_action_add(
                        red, RED_CODE_R, EXPANSION_TYPE_GLOBAL_RELAY, NULL);
                ...
                if (red_code & RED_CODE_r) {
                    red_action_add(
                            red, RED_CODE_r, EXPANSION_TYPE_ALIAS, f_arg);
                ...
                if (red_code & RED_CODE_E) {
                    red_action_add(
                            red, RED_CODE_E, EXPANSION_TYPE_ALIAS, f_arg);
                }
#endif /* HAVE_LMDB */
                ...
                if ((ld = simta_ldap_config(av[ 3 ], domain)) == NULL) {
                    fprintf(stderr,
                            "%s: line %d: Using %s to configure LDAP "
                ...
                if (red_code & RED_CODE_r) {
                    a = red_action_add(
                            red, RED_CODE_r, EXPANSION_TYPE_LDAP, NULL);
                    a->a_ldap = ld;
                } else if (red_code & RED_CODE_R) {
                    a = red_action_add(
                            red, RED_CODE_R, EXPANSION_TYPE_LDAP, NULL);
                ...
                if (red_code & RED_CODE_E) {
                    a = red_action_add(
                            red, RED_CODE_E, EXPANSION_TYPE_LDAP, NULL);
                    a->a_ldap = ld;
                }
#endif /* HAVE_LDAP */
                ...
                if (strcasecmp(av[ 3 ], "DEFAULT") != 0) {
                    ...
                    red->red_deliver_argv =
                            calloc((size_t)(ac - 2), sizeof(char *));
                ...
                if (red_code & RED_CODE_r) {
                    red_action_add(
                            red, RED_CODE_r, EXPANSION_TYPE_PASSWORD, f_arg);
                } else if (red_code & RED_CODE_R) {
                    red_action_add(
                            red, RED_CODE_R, EXPANSION_TYPE_PASSWORD, f_arg);
                }
                ...
                if (red_code & RED_CODE_E) {
                    red_action_add(
                            red, RED_CODE_E, EXPANSION_TYPE_PASSWORD, f_arg);
                }
                ...
                if (red_code & RED_CODE_r) {
                    red_action_add(red, RED_CODE_r, EXPANSION_TYPE_SRS, f_arg);
                } else if (red_code & RED_CODE_R) {
                    red_action_add(red, RED_CODE_R, EXPANSION_TYPE_SRS, f_arg);
                }
                if (red_code & RED_CODE_E) {
                    red_action_add(red, RED_CODE_E, EXPANSION_TYPE_SRS, f_arg);
                }
                ...
                goto error;
                            ...
                            &simta_aggressive_delivery, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_aggressive_expansion, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            simta_debuglog(2, "ALIAS_DB: %s",
                    simta_default_alias_db ? simta_default_alias_db
                                           : "Disabled");
...
#ifdef HAVE_LIBOPENARC
        } else if ((rc = simta_config_bool(
                            "ARC", &simta_arc, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (ac == 2) {
                ...
                simta_debuglog(2, "ARC_DOMAIN: %s", simta_authres_domain);
                continue;
            }
            ...
            fprintf(stderr, "%s: line %d: usage: %s\n", fname, lineno,
                    "AUTHN <ON|OFF|HONEYPOT>");
            goto error;

        } else if ((rc = simta_config_bool("AUTHN_RESULTS", &simta_auth_results,
            ...
            if (ac == 2) {
                ...
                simta_debuglog(
                        2, "AUTHN_RESULTS_DOMAIN: %s", simta_authres_domain);
                continue;
            }
            fprintf(stderr,
        ...
        } else if ((rc = simta_config_int("BANNER_DELAY", &simta_banner_delay,
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_banner_punishment, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
        ...
        } else if ((rc = simta_config_int("BITBUCKET", &simta_bitbucket, 1, ac,
                            av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_int("BOUNCE_SIZE", &simta_max_bounce_size,
                            0, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_bounce_seconds, 0, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
            ...
            simta_debuglog(
                    2, "CHECKSUM_ALGORITHM %s", simta_checksum_algorithm);

        } else if ((rc = simta_config_bool("CHECKSUM_BODY",
                            &simta_checksum_body, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (ac == 1) {
                ...
                if ((errno == 0) && simta_debug >= 0 && (endptr != av[ 1 ])) {
                    simta_debuglog(2, "DEBUG_LOGGING: %d", simta_debug);
                    continue;
                }
            }
            ...
            if (simta_debug > 1) {
                ...
                yaslfree(buf);
                            ...
                            &simta_outbound_command_line_timer, 1, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_outbound_data_session_timer, 0, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_outbound_connection_msg_max, 0, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_min_work_time, 0, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_disk_read_entries, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            goto error;
                            ...
                            &simta_dns_auto_config, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (strcasecmp(av[ 2 ], "BLOCK") == 0) {
                ...
                fprintf(stderr, "%s: line %d: unknown DNS list type: %s", fname,
                        lineno, av[ 2 ]);
                goto error;
            }
            dnsl_add(av[ 1 ], dnsl_type, av[ 3 ], (ac == 5) ? av[ 4 ] : NULL);
            simta_debuglog(2, "DNS_LIST: %s added to %s as %s", av[ 3 ],
                    av[ 1 ], av[ 2 ]);

        } else if ((rc = simta_config_bool("SENDER_LIST",
                            &simta_sender_list_enable, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_unexpanded_time, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_filter_trusted, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            "IPV4", &simta_ipv4, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_bool(
                            "IPV6", &simta_ipv6, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
        ...
        } else if ((rc = simta_config_bool("JAIL_BOUNCES", &simta_bounce_jail,
                            ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_jail_seconds, 1, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_bool("JAIL_LOCAL", &simta_bounce_jail, ac,
                            av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            goto error;
                            ...
                            &simta_max_failed_rcpts, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_max_failed_senders, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_max_message_size, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_q_runner_local_max, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_q_runner_slow_max, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_launch_limit, 0, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
        ...
        } else if ((rc = simta_config_bool("MID_LIST", &simta_mid_list_enable,
                            ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
        ...
        } else if ((rc = simta_config_bool("PROXY", &simta_proxy, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_int("PROXY_TIMEOUT", &simta_proxy_timeout,
                            0, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if ((ac == 2) && (strlen(av[ 1 ]) <= MAXPATHLEN)) {
                ...
                simta_debuglog(
                        2, "PUBLICSUFFIX_FILE: %s", simta_file_publicsuffix);
        ...
        } else if ((rc = simta_config_int("QUEUE_WAIT_MAX", &simta_wait_max, 0,
                            ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_int("QUEUE_WAIT_MIN", &simta_wait_min, 0,
                            ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (ac == 3) {
                ...
                simta_debuglog(
                        2, "RBL_BLOCK: %s\tREASON: %s", av[ 1 ], av[ 2 ]);
            } else {
            ...
            simta_debuglog(2, "RDNS_URL: %s", simta_reverse_url);
                            ...
                            &simta_inbound_accepted_message_timer, 0, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }

        } else if ((rc = simta_config_int("RECEIVE_COMMAND_INACTIVITY_TIMEOUT",
                            &simta_inbound_command_inactivity_timer, 0, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_inbound_global_session_timer, 0, ac, av,
                            fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            simta_debuglog(
                    2, "SEEN_BEFORE_DOMAIN: %s", simta_seen_before_domain);

        } else if ((rc = simta_config_bool("SENDER_CHECKING",
                            &simta_from_checking, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (rc < 0) {
                goto error;
                            ...
                            &simta_listen_backlog, 0, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
        ...
        } else if ((rc = simta_config_bool("SMTP_PORT", &simta_service_smtp, ac,
                            av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_strict_smtp_syntax, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_connect, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_data, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_data_eof, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_default, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_mail, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            &simta_smtp_tarpit_rcpt, 0, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            if (ac == 2) {
                ...
                simta_debuglog(
                        2, "SUBADDRESS_SEPARATOR: %c", simta_subaddr_separator);
                continue;
            }
            fprintf(stderr, "%s: line %d: usage: SUBADDRESS_SEPARATOR <char>\n",
                    fname, lineno);
            goto error;
            ...
            goto error;
                            ...
                            &simta_service_submission, ac, av, fname,
                            lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            "SYNC", &simta_sync, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
                            ...
                            "TLS", &simta_tls, ac, av, fname, lineno)) != 0) {
            if (rc < 0) {
                goto error;
            }
            ...
            goto error;
                            ...
                            &simta_service_smtps, ac, av, fname, lineno)) !=
                   0) {
            if (rc < 0) {
                goto error;
            }
